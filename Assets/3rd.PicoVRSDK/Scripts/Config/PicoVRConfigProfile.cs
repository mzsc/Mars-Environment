...
public class PicoVRConfigProfile
{
    ...
    {
        UNKONWN = 0,//无畸变的一组参数，未适配特定头盔
        SAMSUNG_GEARVR2 = 1,//三星GearVR2
        PICOVR_I = 2,//小鸟看看Pico 1
        SAMSUNG_GEARVR1 = 3,//三星GearVR1
        ANTVR_JT1 = 4,//机饕1
        MOJING_2 = 5,//暴风魔镜2
        MOJING_3 = 6,//暴风魔镜3
        PicoNeo = 7,
    ...
    {
        devLenses = { separation = 0.062f, offset = 0.035f, distance = 0.0358425f, alignment = Lenses.AlignCenter },
    ...
    /// UNKONWN
    /// </summary>
    public static readonly Device UnKonwn = new Device
    {
        devLenses = { separation = 0.062f, offset = 0.035f, distance = 0.0358425f, alignment = Lenses.AlignCenter },
        devMaxFov = { upper = 40.0f, lower = 40.0f, inner = 40.0f, outer = 40.0f },
        devDistortion =
    ...
    /// SAMSUNG_GEARVR1
    /// </summary>
    public static readonly Device Samsung_Gearvr1 = new Device
    {
        devLenses = { separation = 0.063f, offset = 0.035f, distance = 0.0358425f, alignment = Lenses.AlignCenter },
        devMaxFov = { upper = 40.0f, lower = 40.0f, inner = 40.0f, outer = 40.0f },
        devDistortion =
        {
            k1 = 2.333e-06f,
    ...
    /// ANTVR_JT1
    /// </summary>
    public static readonly Device Antvr_Jt1 = new Device
    {
        devLenses = { separation = 0.065f, offset = 0.035f, distance = 0.0358425f, alignment = Lenses.AlignCenter },
        devMaxFov = { upper = 40.0f, lower = 40.0f, inner = 40.0f, outer = 40.0f },
        devDistortion =
        {
            k1 = 2.333e-06f,
    ...
    /// MOJING_2
    /// </summary>
    public static readonly Device MoJing_2 = new Device
    {
        devLenses = { separation = 0.060f, offset = 0.035f, distance = 0.0358425f, alignment = Lenses.AlignCenter },
        devMaxFov = { upper = 40.0f, lower = 40.0f, inner = 40.0f, outer = 40.0f },
        devDistortion =
        {
            k1 = 2.333e-06f,
    ...
    /// MOJING_3
    /// </summary>
    public static readonly Device MoJing_3 = new Device
    {
        devLenses = { separation = 0.060f, offset = 0.035f, distance = 0.0358425f, alignment = Lenses.AlignCenter },
        devMaxFov = { upper = 40.0f, lower = 40.0f, inner = 40.0f, outer = 40.0f },
        devDistortion =
    ...
    {
        devLenses = { separation = 0.0585f, offset = 0.035f, distance = 0.0358425f, alignment = Lenses.AlignCenter },
        devMaxFov = { upper = 40.0f, lower = 40.0f, inner = 40.0f, outer = 40.0f },
        devDistortion =
        {
            k1 = 2.333e-06f,
    ...
    ///  FALCON_PMMA 
    /// </summary>
    public static readonly Device Falcon_Pmma = new Device
    {
        devLenses = { separation = 0.062f, offset = 0.035f, distance = 0.0358425f, alignment = Lenses.AlignCenter },
        devMaxFov = { upper = 40.0f, lower = 40.0f, inner = 40.0f, outer = 40.0f },
        devDistortion =
    ...
    public static PicoVRConfigProfile GetPicoProfile(DeviceTypes deviceType)
    {
        ...
        switch (deviceType)
        {
            case DeviceTypes.UNKONWN:
                {
                    dev = UnKonwn;
                    break;
                }

            case DeviceTypes.PICOVR_I:
                {
                    dev = Pico1;
                    break;
                }

            case DeviceTypes.SAMSUNG_GEARVR1:
                {
                    dev = Samsung_Gearvr1;
                    break;
                }

            case DeviceTypes.ANTVR_JT1:
                {
                    dev = Antvr_Jt1;
                    break;
                }

            case DeviceTypes.MOJING_2:
                {
                    dev = MoJing_2;
                    break;
                }
